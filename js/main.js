angular.module('dtmf', ['ngTouch'])
    .factory('DialerSvc', function ($rootScope) {
        var value = '';
        ...
        return {
            ...
            dial: function () {
                ...
                var when = 0, gap = 100 / 1000, duration = 40 / 1000;
            ...
            resolve: function (key) {
                var row = lut[key].row, col = lut[key].col;
    ...
    .controller('KeypadCtrl', function ($scope, DialerSvc) {
    ...
    .controller('DialerCtrl', function ($rootScope, $scope, DialerSvc) {
        $scope.number = '';

        $rootScope.$on('dial', function () {
            $scope.number = DialerSvc.getNumber();
        });
